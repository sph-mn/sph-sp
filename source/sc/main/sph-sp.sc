...
(pre-define
  ...
  (sp-sine-state size phs frq fmod amod) (sp-wave-state sp-sine-table sp-rate size phs frq fmod amod)
  (sp-sine-state-lfo size phs frq fmod amod)
  (sp-wave-state sp-sine-table-lfo (* sp-rate sp-sine-lfo-factor) size phs frq fmod amod)
...
(declare
  ...
  (sp-wave-state wvf wvf-size size phs frq fmod amod)
