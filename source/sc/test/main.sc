...
(define (test-sp-cheap-filter) status-t
  ...
  (sp-cheap-filter-lp in sp-noise-duration 0.2 1 0 &state out)
  (sp-cheap-filter-lp in sp-noise-duration 0.2 sp-cheap-filter-passes-limit 0 &state out)
  (sp-cheap-filter-lp in sp-noise-duration 0.2 sp-cheap-filter-passes-limit 0 &state out)
...
(define (test-stats) status-t
  ...
  (sp-stat-times-repetition a size &stat-out)
  (test-helper-assert "repetition" (feq 0.0 stat-out))
  ...
  (sp-stat-samples-repetition as size &stat-out)
  (test-helper-assert "samples repetition" (feq 0.0 stat-out))
  ...
  (sp-stat-times-repetition repetition-1 size &stat-out)
  (test-helper-assert "repetition-1" (feq 1.0 stat-out))
  (sp-stat-times-repetition repetition-2 size &stat-out)
  (test-helper-assert "repetition-2" (feq 0.0 stat-out))
