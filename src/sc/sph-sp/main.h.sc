...
(declare
  ...
  (sp-scale-mask divisions) ((static inline sp-scale-t) sp-time-t)
  (sp-scale-make pitch-classes count divisions)
  ((static inline sp-scale-t) sp-time-t* sp-time-t sp-time-t)
  (sp-scale-rotate scale steps divisions) ((static inline sp-scale-t) sp-scale-t sp-time-t sp-time-t)
  (sp-scale-divisions scale) ((static inline sp-time-t) sp-scale-t)
  (sp-scale-first-index scale) ((static inline sp-time-t) sp-scale-t)
  (sp-scale-canonical scale divisions) ((static inline sp-scale-t) sp-scale-t sp-time-t))