(pre-define
  ...
  (sp-malloc-type count type pointer-address) (sph-malloc (* count (sizeof type)) pointer-address)
  (sp-calloc-type count type pointer-address) (sph-calloc (* count (sizeof type)) pointer-address)
  (sp-realloc-type count type pointer-address) (sph-realloc (* count (sizeof type)) pointer-address)
  ...
  (sp-time-random)
  (begin "hangs if sp is not initialized" (sp-time-random-primitive &sp-random-state))
  ...
  local-memory-uninit (memreg2-free-named exit)
  ...
  (sp-local-units-srq size pointer-address) (sp-local-alloc-srq sp-units-init size pointer-address)
...
(declare
  ...
  (sp-block->file block path rate) (status-t sp-block-t char* sp-time-t)
  (sp-block-uninit a) (void sp-block-t*)
  (sp-block-init channel-count sample-count out-block)
  ...
  (sp-status-description a) (char* status-t)
  (sp-status-name a) (char* status-t)
...
(declare
  ...
  (sp-scale-mask divisions) (sp-scale-t sp-time-t)
  (sp-scale-make pitch-classes count divisions) (sp-scale-t sp-time-t* sp-time-t sp-time-t)
