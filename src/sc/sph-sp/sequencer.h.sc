(pre-define
  ...
  (sp-event-uninit a) (if a.free (a.free &a))
  ...
  (sp-event-memory-uninit event-pointer) (sph-memory-destroy &event-pointer:memory)
  (sp-map-event-config-init out) (sp-map-event-config-init-n 1 out)
  (sp-resonator-event-config-init out) (sp-resonator-event-config-init-n 1 out)
  ...
  (sp-event-alloc-srq event-pointer sp-units-init size pointer-address)
...
(declare
  ...
  (sp-resonator-event-config-init-n count out) (status-t sp-time-t sp-resonator-event-config-t**)
  ...
  (sp-resonator-event-uninit event) (void sp-event-t*))
