...
sp_scale_t sp_scale_mask(sp_time_t divisions);
sp_scale_t sp_scale_make(sp_time_t* pitch_classes, sp_time_t count, sp_time_t divisions);
sp_scale_t sp_scale_rotate(sp_scale_t scale, sp_time_t steps, sp_time_t divisions);
