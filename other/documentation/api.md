# functions
~~~
sp_bessel_i0 :: sp_sample_t:value -> sp_sample_t
sp_block_to_file :: sp_block_t:block char*:path sp_time_t:rate -> status_t
...
sp_event_list_add :: sp_event_list_t**:head_pointer sp_event_t:event_value -> status_t
sp_event_list_display_element :: sp_event_list_t*:list -> void
sp_event_list_free :: sp_event_list_t**:head_pointer -> void
sp_event_list_remove :: sp_event_list_t**:head_pointer sp_event_list_t*:list -> void
sp_event_schedule :: sp_event_t:event sp_time_t:onset sp_time_t:duration void*:config -> sp_event_t
sp_fft :: sp_time_t:n double*:real double*:imaginary -> int
sp_ffti :: sp_time_t:n double*:real double*:imaginary -> int
sp_file_close_read :: sp_file_t:file -> void
sp_file_close_write :: sp_file_t*:file -> void
sp_file_open_read :: char*:path sp_file_t*:file -> status_t
sp_file_open_write :: char*:path sp_channel_count_t:channel_count sp_time_t:sample_rate sp_file_t*:file -> status_t
...
sp_force_center_unity :: sp_sample_t*:impulse_response sp_time_t:sample_count -> void
sp_group_add :: sp_event_t*:a sp_event_t:event -> status_t
sp_group_append :: sp_event_t*:a sp_event_t:event -> status_t
sp_group_event_f :: sp_time_t:start sp_time_t:end void*:out sp_event_t*:event -> void
sp_group_event_free :: sp_event_t*:a -> void
sp_group_free :: sp_event_t*:group -> void
sp_group_generate :: sp_time_t:start sp_time_t:end void*:out sp_event_t*:a -> status_t
sp_group_generate_parallel_block :: sp_time_t:start sp_time_t:end sp_block_t:out sp_event_t*:a -> status_t
...
sp_kaiser_window :: sp_time_t:sample_index sp_time_t:window_length sp_sample_t:beta_value -> sp_sample_t
sp_kaiser_window_length :: sp_sample_t:transition_width sp_sample_t:beta_value -> sp_time_t
sp_map_event_config_new_n :: sp_time_t:count sp_map_event_config_t**:out -> status_t
sp_map_event_free :: sp_event_t*:event -> void
sp_map_event_generate :: sp_time_t:start sp_time_t:end void*:out sp_event_t*:event -> status_t
sp_map_event_isolated_generate :: sp_time_t:start sp_time_t:end void*:out sp_event_t*:event -> status_t
...
sp_plot_samples_to_file :: sp_sample_t*:a sp_time_t:a_size char*:path -> void
sp_plot_samples_file :: char*:path uint8_t:use_steps -> void
sp_plot_spectrum :: sp_sample_t*:a sp_time_t:a_size -> void
sp_plot_spectrum_to_file :: sp_sample_t*:a sp_time_t:a_size char*:path -> void
sp_plot_spectrum_file :: char*:path -> void
sp_plot_times :: sp_time_t*:a sp_time_t:a_size -> void
sp_plot_times_to_file :: sp_time_t*:a sp_time_t:a_size char*:path -> void
...
sp_render_file :: sp_event_t:event char*:path -> status_t
...
sp_render_range_file :: sp_event_t:event sp_time_t:start sp_time_t:end sp_render_config_t:config char*:path -> status_t
sp_resonator_event_config_defaults :: -> sp_resonator_event_config_t
sp_resonator_event_config_new_n :: sp_time_t:count sp_resonator_event_config_t**:out -> status_t
sp_resonator_event_free :: sp_event_t*:event -> void
sp_resonator_event_generate :: sp_time_t:start sp_time_t:end void*:out sp_event_t*:event -> status_t
sp_resonator_event_generate_block :: sp_time_t:duration sp_time_t:block_i sp_time_t:event_i void*:out sp_event_t*:event -> status_t
sp_resonator_event_prepare :: sp_event_t*:event -> status_t
sp_resonator_ir :: sp_sample_t:cutoff_low sp_sample_t:cutoff_high sp_sample_t:transition sp_sample_t**:out_ir sp_time_t*:out_len -> status_t
sp_resonator_ir_f :: void*:arguments sp_sample_t**:out_ir sp_time_t*:out_len -> status_t
...
sp_samples_absolute_max :: sp_sample_t*:in sp_size_t:count -> sp_sample_t
...
sp_scale_canonical :: sp_scale_t:scale sp_time_t:divisions -> sp_scale_t
sp_scale_divisions :: sp_scale_t:scale -> sp_time_t
sp_scale_first_index :: sp_scale_t:scale -> sp_time_t
sp_scale_make :: sp_time_t*:pitch_classes sp_time_t:count sp_time_t:divisions -> sp_scale_t
sp_scale_mask :: sp_time_t:divisions -> sp_scale_t
sp_scale_rotate :: sp_scale_t:scale sp_time_t:steps sp_time_t:divisions -> sp_scale_t
sp_seq :: sp_time_t:start sp_time_t:end void*:out sp_event_list_t**:events -> status_t
sp_seq_parallel_block :: sp_time_t:start sp_time_t:end sp_block_t:out sp_event_list_t**:events -> status_t
sp_seq_parallel_generic :: sp_time_t:start sp_time_t:end void*:out sp_event_list_t**:events sp_seq_parallel_generic_config_t*:config -> status_t
...
sp_sinc_make_minimum_phase :: sp_sample_t*:impulse_response sp_time_t:sample_count -> status_t
...
sp_status_description :: status_t:a -> char*
sp_status_name :: status_t:a -> char*
...
sp_times_absolute_max :: sp_time_t*:in sp_size_t:count -> sp_time_t
...
sp_event_memory_add(event_pointer, address)
sp_event_memory_ensure(event_pointer, needed)
sp_event_memory_free(event_pointer)
...
sp_group_parallel_block_event(event_pointer)
sp_hz_to_factor(x)
sp_hz_to_rad(a)
sp_hz_to_samples(x)
sp_inline_abs(a)
...
sp_resonator_event(event_pointer, _config)
sp_resonator_event_config_new(out)
sp_s_group_libc
sp_s_group_sp
sp_s_group_sph
sp_s_id_eof
...
# types
~~~
sp_seq_future_t: sc_insert struct sp_seq_future_t
sp_convolution_filter_ir_f_t: void* sp_sample_t** sp_time_t* -> status_t
sp_event_block_generate_t: sp_time_t sp_time_t sp_time_t void* sp_event_t* -> status_t
sp_event_generate_t: sp_time_t sp_time_t void* sp_event_t* -> status_t
sp_event_prepare_t: sp_event_t* -> status_t
sp_map_generate_t: sp_time_t sp_time_t void* void* void* -> status_t
sp_seq_future_free: void* -> void
sp_seq_future_make: sp_time_t void* void** -> status_t
sp_seq_future_merge: sp_time_t sp_time_t void* sp_seq_future_t* sp_size_t void* -> status_t
sp_seq_future_run: sp_seq_future_t* -> status_t
...
sp_event_t: struct sp_event_t
  ...
  generate: function_pointer status_t sp_time_t sp_time_t void* struct sp_event_t*
...
sp_resonator_event_channel_config_t: struct
  amod: sp_sample_t*
  amp: sp_sample_t
...
sp_resonator_event_config_t: struct
  ...
  noise_in: sp_sample_t*
  noise_out: sp_sample_t*
  bandwidth_threshold: sp_sample_t
  channel_count: sp_channel_count_t
  channel_config: array sp_resonator_event_channel_config_t sp_channel_count_limit
sp_samples_t: struct
  data: void*
  size: size_t
  used: size_t
sp_seq_parallel_generic_config_t: struct
  make: sp_seq_future_make
  free: sp_seq_future_free
  merge: sp_seq_future_merge
  run: sp_seq_future_run
  context: void*
sp_times_t: struct
  data: void*
  size: size_t
